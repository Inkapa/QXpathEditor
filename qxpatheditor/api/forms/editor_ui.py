...
class Ui_Form(object):
    ...
    def retranslateUi(self, Form):
        ...
        self.groupBox.setTitle(_translate("Form", "XPath expression"))
        self.lblError.setText(_translate("Form", "lblError"))
        self.lineEditXPath.setToolTip(_translate("Form", "<html><head/><body><p>Type your XPath expression here</p></body></html>"))
        ...
        self.checkBoxQuickRef.setText(_translate("Form", "Show XPath Quick Reference"))
