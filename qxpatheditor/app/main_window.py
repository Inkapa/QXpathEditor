from qxpatheditor.qt import QtWidgets, QtCore
from qxpatheditor.app.forms import main_window_ui
from qxpatheditor.app.settings import Settings
from qxpatheditor import __version__
...
class MainWindow(QtWidgets.QMainWindow):
    def __init__(self):
        ...
        self.setWindowTitle('QXPathEditor v.%s' % __version__)
        ...
        self.ui.editor.xpath = self._settings.xpath
    ...
    def closeEvent(self, ev):
        ...
        self._settings.xpath = self.ui.editor.xpath
